...
class Prize {
    public:
        ...
        /* 
         * Constructor
         * This is the constructor for class Prize
         */
        Prize ();
        
        /* 
         * Overloaded Constructor
         * This is an overloaded constructor for class Prize that allows
         * arguments to be passes to the function.
         * @param newName is a string that contains a name for the prize
         * @param newValue is an unsigned int that contains a value for the prize
         */
        Prize (string newName, unsigned int newValue);
         
        /* 
         * Set this Prize's name
         * @param newName is a string containing the name for the prize
         */
        void setPrizeName (string newName);
         
        /* 
         * Set this Prize's value
         * @param newValue is an unsigned int containing the value for the prize
         */
         ...
         * @param
         */
         friend bool operator== (string prizeName2, unsigned int prizeValue2);
        
        /* 
         * Destructor
         * This is a destructor for class Prize
         */
         ~Prize ();
